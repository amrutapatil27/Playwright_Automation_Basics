...
Call log:
  - waiting for locator('#lang-trigger')
    - locator resolved to <button type="button" id="lang-trigger" aria-expanded="true" class="select-trigger" aria-haspopup="listbox" data-testid="lang-trigger">…</button>
...
> 11 |    await myDropDown.selectOption('Python');
     |                     ^ Error: locator.selectOption: Error: Element is not a <select> element
