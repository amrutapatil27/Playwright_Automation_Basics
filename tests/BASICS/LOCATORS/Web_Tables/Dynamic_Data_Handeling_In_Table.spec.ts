...
for (let i = 1; i <= rowCount; i++) {
  ...
  /* 
    for loop can be avoided using this
    // The Pro Way: Get everything at once
const allTableData = await page.locator('table [summary="Sample Table"] tbody tr td').allInnerTexts();
  */
